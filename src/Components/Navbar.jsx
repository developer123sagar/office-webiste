  ...
  return (
    <div className="w-full fixed z-10 top-0 left-0">
      <div className="lg:flex items-center justify-between bg-slate-600 text-white py-2 lg:px-10 px-3">
        ...
        <div
          className={`lg:flex lg:items-center lg:pb-0 pb-2 absolute lg:static bg-slate-600 text-white lg:z-auto z-[-1] left-0 w-full lg:w-auto lg:pl-0 pl-9 transition-all duration-500 ease-in ${menuOpen ? "top-14" : "top-[-490px]" }`}>
